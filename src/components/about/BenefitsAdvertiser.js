...
function BenefitsAdvertiser() {
  ...
  return (
    <div className="w-full overflow-hidden lg:px-[160px] mt-10 pb-12 md:pb-0 md:mt-0 md:px-[30px] px-[30px] bg-[#F6F6F6] md:bg-transparent ">
      {/* BENEFITS FOR ADVERTISERS */}
      <div className="w-full mt-10 md:mt-24 lg:mt-[152px] lg:mb-[169.5px]  md:mb-[67px]">
        {/* title */}
        ...
        <MobileViewBenefitsAdvertiser hidden={`hidden`} marginTop={`mt-6`} />
        {/* 3 CARDS */}
        <div className="w-full hidden md:flex flex-col md:flex-row lg:justify-evenly md:justify-between  ">
          {/* card 1 */}
...
export const MobileViewBenefitsAdvertiser = (props) => {
  //**translate hooks */
  const { t } = useTranslation();
  //**props */
